...
public class FirebaseController : MonoBehaviour
{
    ...
    public void LoginUser()
    {
        ...
        {
            showNotificationMessage("Error", "Fields Empty! Please Input In All Details");
            return;
        }
    ...
    void forgetPasswordSubmit(string forgetPasswordEmail)
    {
        auth.SendPasswordResetEmailAsync(forgetPasswordEmail).ContinueWithOnMainThread(task=>{
            ...
            showNotificationMessage("Alert","Successfully Send Email For Your Reset Password");
        }
        );
    }
    void OnApplicationQuit()
    {
        ...
        {
            auth.SignOut();
            Debug.Log("User signed out due to application quit.");

            // Rimuove i dati di login salvati localmente (se presenti)
